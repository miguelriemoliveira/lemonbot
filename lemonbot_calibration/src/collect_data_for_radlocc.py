#!/usr/bin/env python
"""Global optimization using all scan views of aruco markers

This code computes a global optimization of the mat to acquisition transform parameters.
"""
...
if __name__ == "__main__":
    ...
    image_sub = rospy.Subscriber("/camera/rgb/image_raw", Image, ImageReceivedCallback)
    laser_sub = rospy.Subscriber("/laserscan", LaserScan, LaserReceivedCallback)
